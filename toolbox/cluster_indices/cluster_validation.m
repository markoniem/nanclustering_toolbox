...
if (strcmp(distFunc,'ads'))
    ...
    addpath('../../toolbox/cluster_indices/estimated');
...
elseif (strcmp(distFunc,'exp'))
    ...
    addpath('../../toolbox/centroids/expected');
    addpath('../../toolbox/cluster_indices/expected');
end
%
...
if (strcmp(distFunc,'ads'))
    ...
    rmpath('../../toolbox/cluster_indices/estimated');
elseif (strcmp(distFunc,'pds'))
...
elseif (strcmp(distFunc,'exp'))
    ...
    rmpath('../../toolbox/centroids/expected');
    rmpath('../../toolbox/cluster_indices/expected');
end
